...
public class GuitarSpec {
	...
	public boolean matches(GuitarSpec specs) {
		if (this.getBuilder() == specs.getBuilder() && this.getBackWood() == specs.getBackWood()
				&& this.getModel().equalsIgnoreCase(specs.getModel())
				&& this.getNumberOfStrings() == specs.getNumberOfStrings() && this.getTopWood() == specs.getTopWood()
				&& this.getType() == specs.getType()) {
			return true;
		}
		return false;
	}
